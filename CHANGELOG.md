...
- Compact Mode now maps the floating sidebar to the active palette and removes
  Zen's overlapping outer shadows without adding a divider that interrupts the
  browser content edges.
